...
$APPLICATION->SetPageProperty("title", "Контактные данные веб студии  It-Gorod.");
$APPLICATION->SetPageProperty("description", "Адрес офиса компании  It-Gorod а так же Список контактов для связи с нами.");
