...
<div class="page-form">
	<div class="row row-in">		
		<div class="col-md-6">
			<form action="<?=POST_FORM_ACTION_URI?>" method="POST" id="<?=$arResult['ELEMENT_AREA_ID']?>_form" class="form--data form form--data_bg">
				<?=bitrix_sessid_post()?>
				...
				<?foreach($arResult["IBLOCK"]["PROPERTIES"] as $arProp):?>
					...
					<?if($arProp["CODE"] == "FORM_DESCR"):?>
						<?//form description text?>
						<?if(strlen($arProp["DEFAULT_VALUE"]["TEXT"])):?>
							<div class="row mb30">
								<div class="col-md-12">
									<div class="form-group">									
										<?=$arProp["DEFAULT_VALUE"]["TEXT"]?>								    
								    </div>							
								</div>
							</div>
						<?endif;?>	
