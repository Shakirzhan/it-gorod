...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_requests_catalog.xml";
$iblockCode = "md_bitcorp_requests_catalog_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_requests_catalog";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax/catalog.php", array("REQUESTS_CATALOG_IBLOCK" => $iblockID));
?>