...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_advertbig.xml";
$iblockCode = "md_bitcorp_advertbig_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_advertbig";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index_header.php", array("ADVERTBIG_IBLOCK" => $iblockID));
?>