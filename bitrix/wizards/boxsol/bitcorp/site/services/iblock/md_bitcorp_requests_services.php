...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_requests_services.xml";
$iblockCode = "md_bitcorp_requests_services_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_requests_services";
...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_SITE_ID."/components/bitrix/news/services/detail.php", array("REQUESTS_FEEDBACK_IBLOCK" => $iblockID));
?>