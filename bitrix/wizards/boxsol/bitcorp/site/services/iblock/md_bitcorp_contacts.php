...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_contacts.xml";
$iblockCode = "md_bitcorp_contacts_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_contacts";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contacts/index.php", array("CONTACTS_IBLOCK" => $iblockID));
?>