...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_gallery.xml";
$iblockCode = "md_bitcorp_gallery_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_gallery";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/gallery/index.php", array("GALLERY_IBLOCK" => $iblockID));
?>