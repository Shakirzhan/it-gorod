...
/*ZDUyZmZOGMwMzRlYmQ4NDRjZmU4MTZjYzRkMzlmOTIxMDU1ZWY=*/$GLOBALS['____238040560']= array(base64_decode('ZGVmaW'.'5l'));if(!function_exists(__NAMESPACE__.'\\___131251568')){function ___131251568($_1563790021){static $_208242838= false; if($_208242838 == false) $_208242838=array('R'.'U5DT'.'0RF','WQ==');return base64_decode($_208242838[$_1563790021]);}};class CBXFeatures{ public static function IsFeatureEnabled($_134160047){ return true;} public static function IsFeatureEditable($_134160047){ return true;} public static function SetFeatureEnabled($_134160047, $_1123461975= true){} public static function SaveFeaturesSettings($_811906464, $_1411188913){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1935642615){} public static function ModifyFeaturesSettings($_1935642615, $_2083785496){} public static function IsFeatureInstalled($_134160047){ return true;}} $GLOBALS['____238040560'][0](___131251568(0), ___131251568(1));/**/			//Do not remove this
