...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_vacancy.xml";
$iblockCode = "md_bitcorp_vacancy_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_vacancy";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/vacancy/index.php", array("VACANCY_IBLOCK" => $iblockID));
?>