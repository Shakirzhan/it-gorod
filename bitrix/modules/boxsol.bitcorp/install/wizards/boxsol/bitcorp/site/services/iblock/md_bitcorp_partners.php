...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_partners.xml";
$iblockCode = "md_bitcorp_partners_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_partners";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/partners/index.php", array("PARTNERS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index_footer.php", array("PARTNERS_IBLOCK" => $iblockID));
?>