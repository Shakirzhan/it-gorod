...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_stuff.xml";
$iblockCode = "md_bitcorp_stuff_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_stuff";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/staff/index.php", array("STUFF_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/front-team.php", array("STUFF_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/indexblocks.php", array("STUFF_IBLOCK" => $iblockID));
?>