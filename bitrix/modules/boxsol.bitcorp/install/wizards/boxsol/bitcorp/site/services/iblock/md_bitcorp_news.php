...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_news.xml";
$iblockCode = "md_bitcorp_news_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_news";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/news/index.php", array("NEWS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index_footer.php", array("NEWS_IBLOCK" => $iblockID));
?>