...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_requests_projects.xml";
$iblockCode = "md_bitcorp_requests_projects_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_requests_projects";
...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_SITE_ID."/components/bitrix/news/projects/detail.php", array("REQUESTS_PROJECTS_IBLOCK" => $iblockID));
?>