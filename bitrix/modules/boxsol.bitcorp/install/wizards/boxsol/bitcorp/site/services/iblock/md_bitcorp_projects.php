...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_projects.xml";
$iblockCode = "md_bitcorp_projects_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_projects";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/projects/index.php", array("PROJECTS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/front-projects.php", array("PROJECTS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/indexblocks.php", array("PROJECTS_IBLOCK" => $iblockID));
