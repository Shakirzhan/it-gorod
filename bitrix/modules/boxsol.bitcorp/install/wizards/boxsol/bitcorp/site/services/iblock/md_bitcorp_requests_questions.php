...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_requests_questions.xml";
$iblockCode = "md_bitcorp_requests_questions_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_requests_questions";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax/catalog_question.php", array("REQUESTS_CATALOG_QUESTION_IBLOCK" => $iblockID));
?>