...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_faq.xml";
$iblockCode = "md_bitcorp_faq_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_faq";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/faq/index.php", array("FAQ_IBLOCK" => $iblockID));
?>