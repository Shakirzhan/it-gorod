...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_reviews.xml";
$iblockCode = "md_bitcorp_reviews_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_reviews";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/reviews/index.php", array("REVIEWS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/front-reviews.php", array("REVIEWS_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/indexblocks.php", array("REVIEWS_IBLOCK" => $iblockID));
?>