...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_licenses.xml";
$iblockCode = "md_bitcorp_licenses_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_licenses";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/licenses/index.php", array("LICENSES_IBLOCK" => $iblockID));
?>