...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_price.xml";
$iblockCode = "md_bitcorp_price_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_price";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/price/index.php", array("PRICE_IBLOCK" => $iblockID));
?>