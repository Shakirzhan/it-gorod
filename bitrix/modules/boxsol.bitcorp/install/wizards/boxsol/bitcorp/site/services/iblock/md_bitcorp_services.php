...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_services.xml";
$iblockCode = "md_bitcorp_services_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_services";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/index.php", array("SERVICES_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/.left.menu_ext.php", array("SERVICES_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/front-services.php", array("SERVICES_IBLOCK" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/indexblocks.php", array("SERVICES_IBLOCK" => $iblockID));
?>