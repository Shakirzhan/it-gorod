...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_requests_contacts.xml";
$iblockCode = "md_bitcorp_requests_contacts_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_requests_contacts";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/contacts/index.php", array("REQUESTS_CONTACTS_IBLOCK" => $iblockID));
?>