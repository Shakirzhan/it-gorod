...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/md_bitcorp_teasers.xml";
$iblockCode = "md_bitcorp_teasers_".WIZARD_SITE_ID;
$iblockCodeNative = "md_bitcorp_teasers";
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."index_header.php", array("TEASERS_IBLOCK" => $iblockID));
?>