...
{		
	...
	<div class="infospice-search-product">
		<a href="#"><img src="<?=$this->__folder?>/images/blog-icon.png" height="128px" alt="image description" /></a>
		<p><a href="<?=$arPost[ "URL" ]?>"><?=$arPost[ "TITLE" ]?></a></p>
		<ul class="infospice-search-product-info">
			...
			<li>
				<span class="infospice-search-product-param">Комментариев</span>
