<?
$MESS["INFOSPICE_SEARCH_PO_ZAPROSU"] = "По запросу «";
$MESS["INFOSPICE_SEARCH_POISK_PO_SAYTU"] = "Поиск по сайту";
$MESS["INFOSPICE_SEARCH_NICEGO_NE"] = "» ничего не
            найдено";
$MESS["INFOSPICE_SEARCH_VAS_ZOVUT"] = "Вас зовут*";
$MESS["INFOSPICE_SEARCH_VAS"] = "Ваш e-mail*";
$MESS["INFOSPICE_SEARCH_TELEFON"] = "Телефон";
$MESS["INFOSPICE_SEARCH_ISEM_TOVAR"] = "Ищем товар";
$MESS["INFOSPICE_SEARCH_OTPRAVITQ"] = "Отправить";
$MESS["INFOSPICE_SEARCH_REZULQTATY_POISKA_PO"] = "Результаты поиска по категориям";
$MESS["INFOSPICE_SEARCH_NET_KATEGORIY"] = "Нет категорий";
...
$MESS["INFOSPICE_SEARCH_REZULQTATY_POISKA_PO_STR"] = "Результаты поиска по строке «";
$MESS["INFOSPICE_SEARCH_"] = "»";
$MESS["INFOSPICE_SEARCH_R"] = "Р";
$MESS["INFOSPICE_SEARCH_BLOGS"] = "Блог";
$MESS["INFOSPICE_SEARCH_STATIC"] = "Другие страницы";
$MESS["INFOSPICE_SEARCH_FORUM"] = "Форум";

$MESS["INFOSPICE_SEARCH_ALL_RESULTS"] = "Все результаты поиска";
$MESS["INFOSPICE_SEARCH_THANKS"] = "Спасибо";
$MESS["INFOSPICE_SEARCH_WE_CALL_LATER"] = "Мы обязательно свяжемся с вами в ближайшее время.";
?>