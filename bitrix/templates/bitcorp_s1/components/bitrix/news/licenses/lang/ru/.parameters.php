...
$MESS["MD_SHOW_SECTION_PREVIEW_DESCRIPTION"] = "Выводить краткое описание раздела";
$MESS["MD_SHOW_SECTION_NAME"] = "Выводить название раздела";
$MESS["MD_SHOW_IBLOCK_DESCRIPTION"] = "Выводить описание инфоблока";
