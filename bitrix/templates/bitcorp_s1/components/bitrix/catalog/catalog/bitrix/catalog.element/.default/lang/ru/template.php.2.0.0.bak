...
$MESS["MD_CD_ART_NUMBER"] = "Артикул:";


$MESS['CD_MESS_BTN_ORDER_DEFAULT'] = "Заказать товар";
$MESS['CD_MESS_BTN_QUESTION_DEFAULT'] = "Задать вопрос";
$MESS['CD_MESS_TAB_DESCRIPTION_DEFAULT'] = "Описание";
$MESS['CD_MESS_TAB_PROPS_DEFAULT'] = "Характеристики";
$MESS['CD_MESS_TAB_FILES_DEFAULT'] = "Файлы";
?>