...
foreach ($arResult["SECTIONS"] as $key => $arSection){
	...
	if($arSection['DETAIL_PICTURE']){
		...
		$arSection['DETAIL_PICTURE'] = ($arSection['DETAIL_PICTURE'] > 0 ? CFile::GetFileArray($arSection['DETAIL_PICTURE']) : false);
		$arResult['SECTIONS'][$key]['DETAIL_PICTURE'] = $arSection['DETAIL_PICTURE'];
		$arResult['SECTIONS'][$key]['~DETAIL_PICTURE'] = $arSection['~DETAIL_PICTURE'];	
	}	
