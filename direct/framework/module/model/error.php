...
final class Error extends \FrameWork\Common {
	...
	public function __construct () {
		parent::__construct();
		$this->table=$this->Framework->model->config()->TABLE['error'];
	}
	...
	public function delete($PARAM=array(), $ORDER=array(), $LIMIT=array()) {
		$this->Framework->model->api->model->delete($this->table, $PARAM, $ORDER, $LIMIT);
	}
