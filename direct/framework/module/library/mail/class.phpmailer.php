 ...
 */
  ...
  public function Send() {
    try {
      ...
      if ($this->DKIM_domain && $this->DKIM_protected) {
  ...
  */
  ...
  /**
   * Set the protected key file and password to sign the message.
   *
   * @access public
  ...
  public function DKIM_Sign($s) {
    $privKeyStr = file_get_contents($this->DKIM_protected);
    if ($this->DKIM_passphrase!='') {
      $privKey = openssl_pkey_get_protected($privKeyStr,$this->DKIM_passphrase);
    } else {
      $privKey = $privKeyStr;
    }
