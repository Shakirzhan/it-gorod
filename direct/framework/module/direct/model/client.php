...
final class Client extends \FrameWork\Common {
	...
	// https://tech.yandex.ru/direct/doc/dg-v4/live/GetClientInfo-docpage/
	public function get($PARAM=array()) {
		...
		elseif (!empty($Result->error_str))
			$this->Framework->library->error->set('Не удалось получить список клиентов ('.print_r($PARAM, true).print_r($Result, true).').', __FILE__, __NAMESPACE__, __CLASS__, __METHOD__, __LINE__);
		return array();
	}
